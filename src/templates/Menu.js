...
export default function Menu({
  ...
  const options = [
    ...
    { value: "location/japan", label: "japan" },
  ]
      ...
      <div className="menuOptions">
        <div>
          <Select
            styles={customStyles}
            className={
              searching ? "menuLocationSelectHidden" : "menuLocationSelect"
            }
            isSearchable={false}
            theme={theme => ({
              ...theme,
        ...
        {searching ? (
          ...
          <div className="menuViewOptions">
            <IconContext.Provider
              value={{
                color: isFiltering ? "lightgrey" : "#ab9a7a",
                className: isFiltering ? "disabledGridIcon" : "switchViewIcon",
              }}
            >
              <div
            ...
            <IconContext.Provider
              value={{ color: "#ab9a7a", className: "menuSearchIcon" }}
            >
              <div onClick={() => displaySearch()} onKeyDown={null}>
                <AiOutlineSearch />
              </div>
            </IconContext.Provider>
          </div>
